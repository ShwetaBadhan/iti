               ...
               <div class="postbox-details-wrapper it-career-details-area">
                  <div class="postbox-thumb-box mb-60">
                     <div class="postbox-main-thumb border-radius-20 mb-35">
                        <img class="w-100" src="assets/img/blog/details-1-6.jpg" alt="">
                     </div>
                                 ...
                                 <div class="rc-post">
                                    ...
                                    <div class="rc-post-content">
                                       ...
                                       <h5 class="rc-post-title">
                                          <a class="border-line" href="{{ route('blog-details') }}">Dapibus cras nisi suscipit nibh elite <br>purus condimentum</a>
                                       </h5>
                                    </div>
                                 </div>
                              </li>
                              <li>
                                 <div class="rc-post">
                                    ...
                                    <div class="rc-post-content">
                                       ...
                                       <h5 class="rc-post-title">
                                          <a class="border-line" href="{{ route('blog-details') }}">Dapibus cras nisi suscipit nibh elite
                                             purus condimentum</a>
                                       </h5>
                                    </div>
                                 </div>
                  ...
                  <div class="sidebar-contact-wrap theme-bg fix z-index-1 text-center mb-60">
                     ...
                     <div class="sidebar-contact-2 mt-30">
                        ...
                        <div class="sidebar-contact-btn d-block">
                           <a href="{{ route('contact-us') }}" class="it-btn-yellow w-100">
                              <span>
