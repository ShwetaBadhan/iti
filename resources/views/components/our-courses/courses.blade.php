 <!-- course-area-start -->
   <div class="it-course-area it-course-style-2 it-course-style-4 pt-130 pb-130">
      <div class="container">
         <div class="row">
            <div class="col-12">
         ...
         <div class="row gx-35">
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-2.jpg" alt=""></a>
                     <span class="course-category">Study</span>
                  </div>
                  <div class="it-course-content p-relative">
                     <h5 class="it-course-title mb-15"><a class="border-line" href="{{ route('course-details') }}">Design Thinking Researching for Better UX</a></h5>
                     <div class="it-course-text">
                        <p>Fames facilisis orci auctor bibendum nibh. Ultrices cras amet bibendum.</p>
                     </div>
                     <div class="it-course-meta-wrap mb-15">
                        <div class="row">
                     ...
                     <div class="it-course-btn">
                        <a href="{{ route('course-details') }}" class="it-btn-yellow w-100">
                           <span>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-1.jpg" alt=""></a>
                     <span class="course-category">Learn</span>
                  </div>
                  <div class="it-course-content p-relative">
                     <h5 class="it-course-title mb-15"><a class="border-line" href="{{ route('course-details') }}">Upgrade Your Knowledge with Expert Courses</a></h5>
                     <div class="it-course-text">
                        <p>Fames facilisis orci auctor bibendum nibh. Ultrices cras amet bibendum.</p>
                     </div>
                     <div class="it-course-meta-wrap mb-15">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-3.jpg" alt=""></a>
                     <span class="course-category">Teach</span>
                  </div>
                  <div class="it-course-content p-relative">
                     <h5 class="it-course-title mb-15"><a class="border-line" href="{{ route('course-details') }}">Today’s Most Recommended Learning Paths</a></h5>
                     <div class="it-course-text">
                        <p>Fames facilisis orci auctor bibendum nibh. Ultrices cras amet bibendum.</p>
                     </div>
                     <div class="it-course-meta-wrap mb-15">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-4.jpg" alt=""></a>
                     <span class="course-category">Skills</span>
                  </div>
                  <div class="it-course-content p-relative">
                     <h5 class="it-course-title mb-15"><a class="border-line" href="{{ route('course-details') }}">Design Thinking Researching for Better UX</a></h5>
                     <div class="it-course-text">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-5.jpg" alt=""></a>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-6.jpg" alt=""></a>
                     <span class="course-category">Growth</span>
                  </div>
                  <div class="it-course-content p-relative">
                     <h5 class="it-course-title mb-15"><a class="border-line" href="{{ route('course-details') }}">Today’s Most Recommended Learning Paths</a></h5>
                     <div class="it-course-text">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-7.jpg" alt=""></a>
                     <span class="course-category">Focus</span>
                  </div>
                  <div class="it-course-content p-relative">
                     <h5 class="it-course-title mb-15"><a class="border-line" href="{{ route('course-details') }}">Design Thinking Researching for Better UX</a></h5>
                     <div class="it-course-text">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-8.jpg" alt=""></a>
                     <span class="course-category">Books</span>
                  </div>
                  <div class="it-course-content p-relative">
                     <h5 class="it-course-title mb-15"><a class="border-line" href="{{ route('course-details') }}">Upgrade Your Knowledge with Expert Courses</a></h5>
                     <div class="it-course-text">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
               <div class="it-course-item mb-35">
                  <div class="it-course-thumb z-index-1 border-radius-20">
                     <a href="{{ route('course-details') }}"><img class="w-100" src="assets/img/course/course-4-9.jpg" alt=""></a>
                     <span class="course-category">Mindset</span>
                  </div>
                  <div class="it-course-content p-relative">
                     <h5 class="it-course-title mb-15"><a class="border-line" href="{{ route('course-details') }}">Today’s Most Recommended Learning Paths</a></h5>
                     <div class="it-course-text">
            ...
            <div class="col-12">
               <div class="it-pagination text-center mt-45">
                  <nav>
                     <ul>
                        <li>
                           <a href="{{ route('our-courses') }}">
                              <i class="fa-regular fa-arrow-left"></i>
                           </a>
                        </li>
                        <li>
                           <a href="{{ route('our-courses') }}">1</a>
                        </li>
                        <li class="current">
                           <a href="{{ route('our-courses') }}">2</a>
                        </li>
                        <li>
                           <a href="{{ route('our-courses') }}">3</a>
                        </li>
                        <li>
                           <a href="{{ route('our-courses') }}">4</a>
                        </li>
                        <li>
                           <a href="{{ route('our-courses') }}">
