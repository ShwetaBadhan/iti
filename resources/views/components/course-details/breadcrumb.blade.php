  <!-- breadcrumb-area-start -->
   <div class="it-breadcrumb-area it-breadcrumb-ptb it-breadcrumb-course-details-style fix z-index-1" data-background="assets/img/shape/breadcrumb-details-bg.png">
