                                     ...
                                     <span>
                                         <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                             ...
                                             <path
                                                 ...
                                                 fill="{{ route('course-details') }}F8C62F" />
                                         </svg>
                                     </span>
                 ...
                 <div class="row align-items-center">
                     <div class="col-xxl-2 col-xl-2 col-lg-4 col-md-5 col-6">
                         <div class="it-header-logo">
                             <a href="{{ route('home') }}"><img src="assets/img/logo/dr-iti.png" alt=""></a>
                         </div>
                     </div>
                             ...
                             <nav class="it-menu-content">
                                 <ul>
                                     ...
                                     <li class="has-dropdown p-static">
                                         <a href="{{ route('our-courses') }}">Courses</a>
                                             ...
                                             <div class="row gx-50">
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Auto Electrician</h4>
                                                         <ul>
                                                             <li><a href="{{ route('course-details') }}">Auto
                                                                     Electrician (Basic)</a></li>
                                                             <li><a href="{{ route('course-details') }}">Auto
                                                                     Electrician (Advance)</a></li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Automobile</h4>
                                                         <ul>
                                                             <li><a href="{{ route('course-details') }}">Automobile
                                                                     (Basic)</a></li>
                                                             <li><a href="{{ route('course-details') }}">Automobile
                                                                     (Diesel)</a></li>
                                                             <li><a href="{{ route('course-details') }}">Automobile
                                                                     (Petrol)</a></li>
                                                             {{-- <li><a href="{{ route('course-details') }}">Mechanic</a></li> --}}
                                                         </ul>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Mechanical</h4>
                                                         <ul>
                                                             <li><a href="{{ route('course-details') }}">Fitter</a>
                                                             </li>
                                                             <li><a href="{{ route('course-details') }}">Welder</a>
                                                             </li>
                                                             <li><a href="{{ route('course-details') }}">Tool &
                                                                     Die</a></li>
                                                             <li><a href="{{ route('course-details') }}">Pump
                                                                     Operator</a></li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Electrical</h4>
                                                         <ul>
                                                             <li><a
                                                                     href="{{ route('course-details') }}">Electrician</a>
                                                             </li>
                                                             <li><a href="{{ route('course-details') }}">Wireman</a>
                                                             </li>
                                                             <li><a href="{{ route('course-details') }}">Electrical
                                                                     Technician</a></li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Computer & IT</h4>
                                                         <ul>
                                                             <li><a href="{{ route('course-details') }}">Basic
                                                                     Computer</a></li>
                                                             <li><a href="{{ route('course-details') }}">Computer
                                                                     Management</a></li>
                                                             <li><a href="{{ route('course-details') }}">COPA</a></li>
                                                             <li><a href="{{ route('course-details') }}">Tally</a>
                                                             </li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Construction</h4>
                                                         <ul>
                                                             <li><a href="{{ route('course-details') }}">Plumber</a>
                                                             </li>
                                                             <li><a href="{{ route('course-details') }}">Carpenter</a>
                                                             </li>
                                                             <li><a href="{{ route('course-details') }}">Painter</a>
                                                             </li>
                                                             <li><a href="{{ route('course-details') }}">Pipe
                                                                     Fitter</a></li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Beauty & Lifestyle</h4>
                                                         <ul>
                                                             <li><a
                                                                     href="{{ route('course-details') }}">Beautician</a>
                                                             </li>
                                                             <li><a href="{{ route('course-details') }}">Dress
                                                                     Making</a></li>
                                                             <li><a href="{{ route('course-details') }}">Cooking</a>
                                                             </li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Mechanic Safety</h4>
                                                         <ul>
                                                             <li><a href="{{ route('course-details') }}">Fire &
                                                                     Industrial Safety</a></li>
                                                             <li><a href="{{ route('course-details') }}">Hazardous
                                                                     Goods Handling</a></li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="col-xl-2 mb-2">
                                                     <div class="it-megamenu-item">
                                                         <h4 class="it-megamenu-title">Education</h4>
                                                         <ul>
                                                             <li><a href="{{ route('course-details') }}">NTT (Nursery
                                                                     Teacher Training)</a></li>
                                                             <li><a href="{{ route('course-details') }}">ETT
                                                                     (Elementary Teacher Training)</a></li>
                                                             <li><a href="{{ route('course-details') }}">Nanny
                                                                     Training</a></li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                     ...
                                     <li class="has-dropdown">
                                         ...
                                         <ul class="it-submenu submenu">
                                             <li><a href="{{ route('our-campus') }}">Campus Photos</a></li>
                     ...
                     <div class="col-xxl-3 col-xl-3 col-lg-8 col-md-5 col-6">
                         <div class="it-header-right-action d-flex justify-content-end align-items-center">


                             <a href="javascript:void(0)" class="it-btn-yellow d-none d-md-flex">
                                 <span>
