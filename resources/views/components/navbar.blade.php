                     ...
                     <ul>
                        <li class="d-none d-lg-inline-block d-lg-inline-block">
                           <div class="it-header-top-contact d-flex align-items-center">      
                              ...
                              <a class="border-line" href="tel:9814054591"> 0181-2783091, +91-98140-54591</a>
                           </div>
                        </li>
                        <li>
                           <div class="it-header-top-contact d-flex align-items-center">
                              ...
                              <a class="border-line" href="mailto:ambedkariti@ymail.com">ambedkariti@ymail.com</a>
                           </div>
                        </li>
                     </ul>
                  </div>
               </div>      
               <div class="col-xl-6 col-lg-6 col-md-8 col-sm-7 d-none d-sm-block">
      ...
      <div class="row gx-50">
         ...
         <div class="col-xl-2 mb-2">
            <div class="it-megamenu-item">
               ...
               <ul>
                  <li><a href="{{ route('course-details') }}">Auto Electrician (Basic)</a></li>
                  <li><a href="#">Auto Electrician (Advance)</a></li>
               </ul>
            </div>
         </div>
         ...
         <div class="col-xl-2 mb-2">
            <div class="it-megamenu-item">
               ...
               <ul>
                  <li><a href="#">Automobile (Basic)</a></li>
                  <li><a href="#">Automobile (Diesel)</a></li>
                  <li><a href="#">Automobile (Petrol)</a></li>
         ...
         <div class="col-xl-2 mb-2">
            <div class="it-megamenu-item">
               ...
               <ul>
                  ...
                  <li><a href="#">Electrical Technician</a></li>
               </ul>
            </div>
         </div>
         ...
         <div class="col-xl-2 mb-2">
            <div class="it-megamenu-item">
               ...
               <ul>
                  <li><a href="#">Fire & Industrial Safety</a></li>
                  <li><a href="#">Hazardous Goods Handling</a></li>
               </ul>
            </div>
         </div>
         ...
         <div class="col-xl-2 mb-2">
            <div class="it-megamenu-item">
               ...
               <ul>
                  ...
                  <li><a href="#">ETT (Elementary Teacher Training)</a></li>
