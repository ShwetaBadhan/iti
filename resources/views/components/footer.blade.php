            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="it-footer-widget it-footer-col-1-1">
                     ...
                     <div class="it-footer-widget-btn">
                        <a href="{{ route ('contact-us')}}" class="it-btn-yellow theme-bg">
                           <span>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-50 wow itfadeUp" data-wow-duration=".9s"
                  ...
                  <div class="it-footer-widget it-footer-col-1-3">
                     <h4 class="it-footer-widget-title">Our Courses</h4>
                     <div class="it-footer-widget-menu">
                        <ul>
                           <li><a href="#">Auto Electrician (Basic)</a></li>
                           <li><a href="#">Automobile (Basic)</a></li>
                           <li><a href="#">Fitter</a></li>
                           <li><a href="#">Welder</a></li>
                           <li><a href="#">Tool & Tie</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            <div class="row align-items-center">
               <div class="col-xl-6 col-lg-5">
                  <div class="it-copyright-left style-2 text-center text-lg-start">
                     <p class="mb-0">Copyright © 2025 <a href="#">Dr. B.R Ambedkar ITI</a> | Developed by DS Innovative Solutions</p>
                  </div>
               </div>
